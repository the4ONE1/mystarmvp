...
const ADDONS = [
  {
    ...
    price: 999,
    priceDisplay: '$9.99',
    priceId: process.env.STRIPE_PRICE_AUDIOBOOK || 'price_1ToarQFABTce6JHknM5PrJ4c',
  },
  {
    id: 'coloring-book',
    ...
    price: 399,
    priceDisplay: '$3.99',
    priceId: process.env.STRIPE_PRICE_COLORING_BOOK || 'price_1ToarUFABTce6JHk4gzcClnG',
  },
  {
    ...
    price: 999,
    priceDisplay: '$9.99',
    priceId: process.env.STRIPE_PRICE_ADDITIONAL_CHARACTER || 'price_1ToarfFABTce6JHk6JWz2bdq',
  },
];
