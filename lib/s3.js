...
// Canonical bucket variable is AWS_S3_BUCKET (matches app/api/upload/presign/route.js
// and AWS_S3_SETUP.md). Older deployments may still set S3_BUCKET_NAME.
const BUCKET_NAME = process.env.AWS_S3_BUCKET || process.env.S3_BUCKET_NAME || 'mestar-photos-placeholder';
